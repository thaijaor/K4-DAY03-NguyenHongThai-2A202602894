...
class GeminiProvider(BaseLLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = None, base_url: str = None):
        ...
        self.base_url = base_url or os.getenv("GEMINI_BASE_URL") or None
...
class OpenAIProvider(BaseLLMProvider):
    """OpenAI Provider (Native Tool Calling với OpenAI SDK, hỗ trợ endpoint OpenAI-compatible qua OPENAI_BASE_URL)"""
    def __init__(self, api_key: str = None, model: str = None, base_url: str = None):
        self.api_key = api_key or os.getenv("OPENAI_API_KEY")
        self.model_name = model or os.getenv("LLM_MODEL") or "gpt-4o-mini"
        # OpenAI SDK tự đọc OPENAI_BASE_URL từ môi trường; chuỗi rỗng sẽ làm hỏng URL nên luôn truyền giá trị cụ thể
